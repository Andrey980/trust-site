...
export default function Footer() {
  return (
    <footer className="w-full bg-[#1082a6] pt-16 pb-8 px-4 text-white">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="pt-4">
                    <p className="text-gray-100">{footerLinks.relacionamento.contato.telefone}</p>
                    <a 
              ...
              <div>
                ...
                <div className="flex gap-8 lg:gap-6 items-center">
        ...
        <div className="mt-8 pt-8 border-t border-white/20">
          <p className="text-gray-100 text-sm text-center">
            © Copyright 2000-2025 Trust Seguros
          </p>
        </div>
      </div>
    </footer>
